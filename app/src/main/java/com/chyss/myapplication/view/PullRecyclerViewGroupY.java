...
/**
 * 为RecyclerView类增加回弹效果,要求PullRecyclerViewGroup中必须有且只有一个RecyclerView
 * manager.setOrientation(LinearLayoutManager.VERTICAL);
 *
 * @author  chyss 2017/04/24
 */
public class PullRecyclerViewGroupY extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener
{
    // 回滚时间
    ...
    public PullRecyclerViewGroupY(Context context)
    {
        this(context, null);
        init();
    }

    public PullRecyclerViewGroupY(Context context, AttributeSet attrs)
    {
        this(context, attrs, 0);
        init();
    }

    public PullRecyclerViewGroupY(Context context, AttributeSet attrs, int defStyleAttr)
    {
