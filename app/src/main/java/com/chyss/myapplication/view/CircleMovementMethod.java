...
/**
 * @Description BaseMovementMethod
 * @Author jinwang
 * @Time 2016/11/11 10:19
 */
public class CircleMovementMethod extends BaseMovementMethod {

    private final static int DEFAULT_TEXTVIEW_BG_COLOR = R.color.white;
    private final static int DEFAULT_CLICKABLESPAN_BG_COLOR = R.color.white;
    /**
     * @Description 整个textView的背景色
     */
    private int textViewBgColor;
    /**
     * @Description 点击部分文字时部分文字的背景色
     */
    ...
    /**
     * @Description true：响应textview的点击事件;false：响应设置的clickableSpan事件
     */
    ...
    public CircleMovementMethod(Context context) {
        ...
        this.textViewBgColor = context.getResources().getColor(DEFAULT_TEXTVIEW_BG_COLOR);
        this.clickableSpanBgColor = context.getResources().getColor(DEFAULT_CLICKABLESPAN_BG_COLOR);
    }

    /**
     * @param clickableSpanBgColor 点击部分文字时部分文字的背景色
     */
    public CircleMovementMethod(int clickableSpanBgColor) {
        this.clickableSpanBgColor = clickableSpanBgColor;
        this.textViewBgColor = mContext.getResources().getColor(DEFAULT_TEXTVIEW_BG_COLOR);
    }

    /**
     * @param clickableSpanBgColor 点击部分文字时部分文字的背景色
     * @param textViewBgColor      整个textView的背景色
     */
